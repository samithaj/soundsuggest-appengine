package kul.cs.hci.soundsuggest.server;

import be.kuleuven.cs.som.annotate.Basic;
import be.kuleuven.cs.som.annotate.Model;
import kul.cs.hci.soundsuggest.shared.lastfm.Artist;
import kul.cs.hci.soundsuggest.shared.lastfm.Caller;
import kul.cs.hci.soundsuggest.shared.lastfm.PaginatedResult;
import kul.cs.hci.soundsuggest.shared.lastfm.Session;
import kul.cs.hci.soundsuggest.shared.lastfm.Tasteometer;
import kul.cs.hci.soundsuggest.shared.lastfm.User;
...
public class DataService extends HttpServlet {
	 ...
	 */
	private static final long serialVersionUID 			= -6128416459917260493L;
